...
5. If you need to use EPID attestation, supplement the configuration information in `global/general_settings.h`. For more information, visit https://api.portal.trustedservices.intel.com/EPID-attestation.
