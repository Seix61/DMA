...
#include "Enclave_t.h"
#include "consensus/socket/peer.h"
...
extern int ignoreOriginalTrust;
extern GeneralSettings::AttestationType originalAttestationType;

int ConsensusPeer::setCert(SSL *session, void *arg, const unsigned char *peer_nonce, size_t peer_nonce_size,
...
int ConsensusPeer::verifyCert(X509 *&cert, const unsigned char *self_nonce, size_t self_nonce_size,
