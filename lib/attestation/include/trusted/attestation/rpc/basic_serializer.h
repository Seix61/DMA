...
#ifndef LIB_TRUSTED_ATTESTATION_RPC_BASIC_MESSAGE_SERIALIZER_H
#define LIB_TRUSTED_ATTESTATION_RPC_BASIC_MESSAGE_SERIALIZER_H
...
#endif //LIB_TRUSTED_ATTESTATION_RPC_BASIC_MESSAGE_SERIALIZER_H
